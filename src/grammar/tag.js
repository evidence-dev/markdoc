...
function peg$parse(input, options) {
  ...
  var peg$e7 = peg$otherExpectation('variable');
  var peg$e8 = peg$otherExpectation('null');
  ...
  var peg$f7 = function (classes) {
    return classes;
  };
  var peg$f8 = function (attribute) {
    return attribute;
  };
  ...
  var peg$f11 = function (name, head, tail) {
    return head ? [head, ...tail] : [];
  };
  var peg$f12 = function (name, params) {
    let parameters = {};
  ...
  var peg$f16 = function (prefix, head, tail) {
